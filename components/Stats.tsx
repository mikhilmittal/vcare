export default function Stats() {
  const badges = [
    {
      icon: (
        <svg className="w-8 h-8 mx-auto mb-3 text-primary-100" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <section id="about" className="py-16 px-4 bg-primary-600 text-white">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
          Now Serving Jamshedpur
        </h2>
        <p className="text-primary-100 text-center mb-12 max-w-2xl mx-auto">
          Bringing trusted home healthcare to your doorstep in Jamshedpur
        </p>
